...
export default function Page() {
  ...
  {logos.map((item, index) => (
    ...
    <div className="mx-6 mb-20">
        ...
        <h2 className="text-2xl sm:mr-0">As energy is a touchy subject, Stelio is comitted to making energy provision as easy as possible just with the click of a button.</h2>
        ...
        <div>
        <h2 className="text-xl font-semibold pb-5">01 <br/> Energizing Communities, Sustaining the Planet</h2>
        ...
        <div>
        <h2 className="text-xl font-semibold pb-5">02 <br/> Empowering Trust</h2>
